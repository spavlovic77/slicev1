...
const Header = ({  icon, showSpinnerPot, showSpinnerWith, showSpinnerStake, showSpinnerUnstake, charity, lsb, accounts, web3, pendingWithdrawal, onWithdraw,onPotWithdraw, onStaking, onUnStaking, vSliceBalance, charityBalance, address, staked }) => {
        ...
        <>          
                <section className='header'>
                    <ul className='charity'>
                        <li>
                            Charity {charityBalanceFormated} <Icon fill="grey" size={14} svg={icon}/>
                        </li>
                        <li>
                        <Icon fill="grey" size={18} style={{display: 'inline'}} svg="user"/> {charity.substring(0,6)}...{charity.substring(38,42)}
                        </li>
                    </ul>
                    <ul className='pot'>
                        <li>
                            {(lso && lsb) && <div>Last Spot Pot  {lsBalanceFormated} <Icon fill="grey" size={14} svg={icon}/></div> }
                    ...
                    <ul className='earn'>
                        <li>
                            You Earned {pendingWithFormated} <Icon fill="grey" size={14} svg={icon}/>
                        </li> 
                        <li className='wallet'>
