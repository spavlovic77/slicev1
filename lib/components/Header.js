...
const Header = ({  showSpinnerStake, showSpinnerUnstake, charity, lsb, accounts, web3, pendingWithdrawal, onWithdraw,onPotWithdraw, onStaking, onUnStaking, vSliceBalance, charityBalance, address, staked }) => {
    ...
    return (
        <> 
                ...
                <section className='header'>
                    ...
                    <ul className='pot'>
                        <li>
                            {(lso && lsb) && <div>Winners Pot  {Web3.utils.fromWei(lsb, 'ether')}</div> }
