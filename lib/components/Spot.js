...
const Spot = ({ showSpinnerReset, showSpinnerReserve, showSpinnerFlip, fightData, accounts, spot, onSpotReset, onSpotFlip, onSpotReservation }) => {
        ...
        <>
            <article className='card'>
                ...
                <ul className='card-buttons'>
                  <li>
                  {!showSpinnerReserve && (spot.flipper.toLowerCase() !=accounts[0] && spot.bu <= timeInt/1000 && spot.ru <= timeInt/1000)  ? <Button variant="outline-secondary" onClick={() => onSpotReservation(spot.SpotNo)}>Reserve</Button> : <Button variant="outline-secondary" onClick={() => onSpotReservation(spot.SpotNo)} disabled>Reserve</Button>}
