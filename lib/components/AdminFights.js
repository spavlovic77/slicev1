                ...
                <Form>
                    <Form.Group className="mb-3" controlId="price">
                        <FloatingLabel controlId="floatingInput" label="Enter initial price of spot" className="mb-3">
                            <Form.Control type="text" placeholder="Initial price of spot" onChange={(e) => setPrice(e.target.value)} onChange={(e) => toWeiValue(e.target.value)}/>
                        </FloatingLabel>
                    </Form.Group>
                    ...
                    <Form.Group className="mb-3" controlId="Duration">
                        <FloatingLabel controlId="floatingInput" label="Enter duration of the challange (in hours)" className="mb-3">
                            <Form.Control type="text" placeholder="Enter duration of the challange (in hours)" onChange={(e) => setDuration(e.target.value)} onChange={(e) => durationToSeconds(e.target.value)}/>
                        </FloatingLabel>
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="Extention">
                        <FloatingLabel controlId="floatingInput" label="Challange prolongation in minutes (Max.60)" className="mb-3">
                            <Form.Control type="text" placeholder="Challange prolongation" onChange={(e) => setExtention(e.target.value)} onChange={(e) => extentionToSeconds(e.target.value)}/>
                        </FloatingLabel>
                    </Form.Group>
