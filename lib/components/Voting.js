...
const Voting = ( { whitel, isReg, shortUrl, showSpinnerVote1, showSpinnerVote2, address, startTime, timer, votes1, votes2, onVote1, onVote2 }) => {
    ...
    return (
        ...
        <div className='center'>
            ...
            <Icon fill="grey" size={32} svg="arrowCircleLeft"/>
                    {(isReg==0 && whitel==false) && <Button  disabled variant="outline-secondary" onClick={onVote1}>Vote</Button>}
                    {(!showSpinnerVote1 && isReg!=0 && whitel!=false) && <Button  variant="outline-secondary" onClick={onVote1}>Vote</Button>}
                ...
                <li className='center-button-right'>
                    {(isReg==0 && whitel==false) && <Button  disabled variant="outline-secondary" onClick={onVote2}>Vote</Button>}
                    {(!showSpinnerVote2 && isReg!=0 && whitel!=false) && <Button  variant="outline-secondary" onClick={onVote2}>Vote</Button>}<Icon fill="grey" size={32} svg="arrowCircleRight"/>
