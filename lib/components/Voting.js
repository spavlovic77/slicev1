    ...
    return (
        ...
        <div className='center'>
            <ul className='center-timer'>
                <li>
                    <Icon fill="grey" size={20} svg="bell"/> {dist > 0 ? (days <10 ? '0'+days : days) +':'+(hours <10 ? '0'+hours : hours)+':'+(minutes <10 ? '0'+ minutes : minutes)+':'+(seconds <10 ? '0'+seconds : seconds) : 'Refresh window'}
                 </li>
            </ul>
            ...
            <Icon fill="grey" size={32} svg="arrow circle left"/>
