           ...
           <td><Button variant='outline-secondary' onClick={()=> handleShow(fight.fightContract)}>Add fight data</Button></td>
                ...
                <Form noValidate>
                    ...
                    <FloatingLabel controlId="floatingInput" label="Enter price of first spot" className="mb-3">
                            <Form.Control required type="number" placeholder="Enter price of first spot" onChange={(e) => setPrice(e.target.value)} onChange={(e) => toWeiValue(e.target.value)} />
                    ...
                    <Form.Group className="mb-3" controlId="Duration">
                        <FloatingLabel controlId="floatingInput" label="Enter duration of the fight in hours (max 168)" className="mb-3">
                            <Form.Control type="text" placeholder="Enter duration of the fight in hours (max 168)" onChange={(e) => setDuration(e.target.value)} onChange={(e) => durationToSeconds(e.target.value)} required/>
                        </FloatingLabel>
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="Extention">
                        <FloatingLabel controlId="floatingInput" label="Fight extention in minutes (Max.60)" className="mb-3">
                            <Form.Control type="text" placeholder="Fight extention" onChange={(e) => setExtention(e.target.value)} onChange={(e) => extentionToSeconds(e.target.value)} required/>
                        </FloatingLabel>
                    </Form.Group>
