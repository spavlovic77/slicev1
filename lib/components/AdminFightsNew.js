            ...
            />}
                ...
                <Form noValidate>
                    ...
                    <Form.Group className="mb-3" controlId="Duration">
                        <FloatingLabel controlId="floatingInput" label="Enter duration of the fight in hours (min 24 - max 168)" className="mb-3">
                            <Form.Control type="text" placeholder="Enter duration of the fight in hours (min 24 - max 168)"  onChange={(e) => durationToSeconds(e.target.value)} required/>
                        </FloatingLabel>
                    </Form.Group>
