    ...
    return (
          ...
          <div className='container'>
              ...
              <ul className='registerOrMint'>
                <li>
                  <Tag
                    color="green"
                    text={(isRegistered && mintSpeed && start) && notYetMinted() +` SLICE`}
                  />
                  </li>
                  <li>
                  {wl ? 
                  <Button variant="outline-secondary" onClick={onMint}>Mint</Button>
      ...
      <Modal show={show} onHide={handleClose} backdrop="static">
        ...
        <Modal.Footer>
          ...
          {addressCheckResults ? <Button variant="outline-warning" type = 'submit' onClick={handleNewFight}> Create fight </Button> : <Button variant="outline-warning" type = 'submit' onClick={handleNewFight}  disabled>Create fight </Button>}
        </Modal.Footer>
      </Modal>
