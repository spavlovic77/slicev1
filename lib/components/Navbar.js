        ...
        <nav className='navbar'>
          <div className='container'>
              ...
              <ul className='registerOrMint'>
                <li>
                  {(isRegistered && mintSpeed && start && mintedDate) && <Tag
                    color="green"
                    text={notYetMinted() +` SLICE`}
                  />}
                  </li>
                  <li>
                  {(wl && showSpinnerMinter)&& <Button hidden variant="outline-secondary" onClick={onMint}>Mint</Button>}
                  {(wl && !showSpinnerMinter) && <Button variant="outline-secondary" onClick={onMint}>Mint</Button>}
                  {!wl && <Button variant="outline-secondary" onClick={handleRegister}>Register</Button>}
