...
import { Select, Icon, Tag, Tooltip, TooltipText } from 'web3uikit';
...
useEffect(() => {
  if (networkId==1) {setDefaultOption('2')}
  else if (networkId==56) {setDefaultOption('1')}
  else if (networkId==137){setDefaultOption('0')}
  else if (networkId==43114){setDefaultOption('3')}
  else if (networkId==5777){setDefaultOption('4')}
}, [])
...
const networks = {
  ...
  ethereum : {
    ...
    rpcUrls: ["https://speedy-nodes-nyc.moralis.io/dcdecbab6c9c13012482ceff/eth/mainnet"],
...
const insertCharity =() => {
  ...
  document.getElementById("charity777").value = '0xE6aAaD066dE84060d22040b54e816045a7E1FFBf';
addressCheck2('0xE6aAaD066dE84060d22040b54e816045a7E1FFBf')}
  else {document.getElementById("charity777").value = '';
addressCheck2('')}
}
      ...
      <Modal show={show} onHide={handleClose} backdrop="static">
        ...
        <Modal.Body>
                <Form>
                    ...
                    <FloatingLabel controlId="opponent" label="Opponents address">
                    ...
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                    <FloatingLabel label="Charity address">
                      <Form.Control id="charity777" type="text" placeholder="Enter charity address"  onChange={(e) => addressCheck2(e.target.value)}/>
                   </FloatingLabel>
                   <Form.Check type="switch" id="custom-switch" onChange={()=>insertCharity()} label="Use Platform Charity address"/>
                    <br></br>
