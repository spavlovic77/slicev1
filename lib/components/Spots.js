...
const Spots = ({ spotResPrice, icon, showFlipModal, buyModalShow, showSpinnerBuy, showSpinnerReset, showSpinnerReserve, showSpinnerFlip, fightData, accounts, spots, onSpotReset, onSpotFlip, onSpotReservation, onBuySpot }) => {
  ...
  if (buyModalShow===false) {
    ...
    return (
        ...
        <section className='card-list'>
            {spots.map((spot)=>(
            <Spot spotResPrice={spotResPrice} icon={icon} showFlipModal={showFlipModal} showSpinnerReset = {showSpinnerReset} showSpinnerReserve={showSpinnerReserve} showSpinnerFlip={showSpinnerFlip} fightData={fightData} accounts ={accounts} key={spot.SpotNo} spot={spot} onSpotReservation={onSpotReservation} onSpotFlip={onSpotFlip} onSpotReset={onSpotReset}    >
            </Spot>    
            )
            )}
        </section>
