...
const Spots = ({ fightData, accounts, spots, onSpotReset, onSpotFlip, onSpotReservation, onBuySpot }) => {
    ...
    return (
        ...
        <section className='card-list'>
            {spots.map((spot)=>(
            <Spot fightData={fightData} accounts ={accounts} key={spot.SpotNo} spot={spot} onSpotReservation={onSpotReservation} onSpotFlip={onSpotFlip} onSpotReset={onSpotReset}    >
            </Spot>    
            )
            )}
        </section>
