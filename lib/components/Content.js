...
const Content = ({ showSpinnerPot, showSpinnerWith, shortUrl, showSpinnerVote1, showSpinnerVote2, showSpinnerStake, showSpinnerUnstake, charity, startTime, timer, lsb, accounts, web3, address, fightData, staked, charityBalance, vSliceBalance,pendingWithdrawal, onWithdraw,onPotWithdraw, onStaking, onUnStaking,votes1, votes2, onVote1, onVote2 }) => {
