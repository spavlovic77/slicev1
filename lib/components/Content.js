...
const Content = ({ showSpinnerVote1, showSpinnerVote2, showSpinnerStake, showSpinnerUnstake, charity, startTime, timer, lsb, accounts, web3, address, fightData, staked, charityBalance, vSliceBalance,pendingWithdrawal, onWithdraw,onPotWithdraw, onStaking, onUnStaking,votes1, votes2, onVote1, onVote2 }) => {
 ...
 <div className='flex-container'>
   <div className='left'>
        <ReactPlayer url={fightData[9]} width='75%' height='100%'/>
        <button className= 'btn-promo' onClick={handleShow}><Icon    fill="grey"    size={24}    svg="more vert"  /></button>
   </div>
   <div className='content-center'>
        <Voting showSpinnerVote1={showSpinnerVote1} showSpinnerVote2={showSpinnerVote2} address ={address} startTime={startTime} timer={timer} onVote1={onVote1} onVote2={onVote2} votes1={votes1} votes2={votes2}/>
   </div>   
   <div className='right'>
        <button className= 'btn-promo' onClick={handleShow}><Icon    fill="grey"    size={24}    svg="more vert"  /></button>
