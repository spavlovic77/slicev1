...
const Content = ({ charity, startTime, timer, lsb, accounts, web3, address, fightData, staked, charityBalance, vSliceBalance,pendingWithdrawal, onWithdraw,onPotWithdraw, onStaking, onUnStaking,votes1, votes2, onVote1, onVote2 }) => {
 ...
 <div className='flex-container'>
   ...
   <div className='content-center'>
        <Voting address ={address }startTime={startTime} timer={timer} onVote1={onVote1} onVote2={onVote2} votes1={votes1} votes2={votes2}/>
   </div>   
   <div className='right'>
        <button className= 'btn-promo' onClick={handleShow}><Icon    fill="grey"    size={24}    svg="more vert"  /></button>
